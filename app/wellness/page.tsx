    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <header className="mb-6">
          <h1 className="text-3xl font-bold mb-2">Health & Wellness Hub</h1>
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Button
                ...
                className="border-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 bg-transparent"
              >
                Reset Day
              </Button>
            </CardTitle>
        ...
        <Card className="mb-6 shadow-sm">
          <CardHeader className="p-0">
            <button
              className="w-full p-4 text-left hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 transition-colors rounded-t-lg"
              onClick={() => setIsFoodTrackerOpen(!isFoodTrackerOpen)}
              aria-expanded={isFoodTrackerOpen}
              aria-controls="food-tracker-content"
            >
              <CardTitle className="flex items-center justify-between">
                <span>Anti-Inflammatory Food & Drink Tracker</span>
            ...
            <CardContent id="food-tracker-content" role="region" aria-labelledby="food-tracker-header">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {Object.entries(groupedFoods).map(([category, foods]) => (
                  <div key={category}>
                    <h3 className="font-semibold mb-3 text-green-600">{category}</h3>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2"
                >
